...
mints(index: number):string
mints(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
mints(index: number,optionalEncoding?:any):string|Uint8Array|null {
...
p2pkPrivKey(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
p2pkPrivKey(optionalEncoding?:any):string|Uint8Array|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? this.bb!.__string(this.bb_pos + offset, optionalEncoding) : null;
}

p2pkPubKey():string|null
p2pkPubKey(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
p2pkPubKey(optionalEncoding?:any):string|Uint8Array|null {
...
constructor(
  public mints: (string)[] = [],
  public p2pkPrivKey: string|Uint8Array|null = null,
  public p2pkPubKey: string|Uint8Array|null = null,
