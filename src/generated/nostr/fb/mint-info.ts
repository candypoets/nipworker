...
baseUnits(index: number):string
baseUnits(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
baseUnits(index: number,optionalEncoding?:any):string|Uint8Array|null {
