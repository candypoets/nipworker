...
export class Kind7Parsed implements flatbuffers.IUnpackableObject<Kind7ParsedT> {
...
static getRootAsKind7Parsed(bb:flatbuffers.ByteBuffer, obj?:Kind7Parsed):Kind7Parsed {
  return (obj || new Kind7Parsed()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}
...
targetCoordinates(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
targetCoordinates(optionalEncoding?:any):string|Uint8Array|null {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.__string(this.bb_pos + offset, optionalEncoding) : null;
}

static startKind7Parsed(builder:flatbuffers.Builder) {
...
export class Kind7ParsedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public targetCoordinates: string|Uint8Array|null = null
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  Kind7Parsed.startKind7Parsed(builder);
  Kind7Parsed.addReactionType(builder, this.reactionType);
  Kind7Parsed.addEventId(builder, eventId);
  Kind7Parsed.addPubkey(builder, pubkey);
  Kind7Parsed.addEventKind(builder, this.eventKind);
  Kind7Parsed.addEmoji(builder, emoji);
  Kind7Parsed.addTargetCoordinates(builder, targetCoordinates);
