...
authors(index: number):string
authors(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
authors(index: number,optionalEncoding?:any):string|Uint8Array|null {
