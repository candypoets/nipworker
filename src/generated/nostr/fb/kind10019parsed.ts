...
unpackTo(_o: Kind10019ParsedT): void {
  _o.trustedMints = this.bb!.createObjList(this.trustedMints.bind(this), this.trustedMintsLength());
  _o.p2pkPubkey = this.p2pkPubkey();
  _o.readRelays = this.bb!.createScalarList(this.readRelays.bind(this), this.readRelaysLength());
}
}

export class Kind10019ParsedT {
constructor(
