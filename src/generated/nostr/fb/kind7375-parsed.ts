...
deletedIds(index: number):string
deletedIds(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
deletedIds(index: number,optionalEncoding?:any):string|Uint8Array|null {
