...
export class EventPointer implements flatbuffers.IUnpackableObject<EventPointerT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EventPointer {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEventPointer(bb:flatbuffers.ByteBuffer, obj?:EventPointer):EventPointer {
  return (obj || new EventPointer()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEventPointer(bb:flatbuffers.ByteBuffer, obj?:EventPointer):EventPointer {
...
static startEventPointer(builder:flatbuffers.Builder) {
...
static endEventPointer(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  builder.requiredField(offset, 4) // id
  return offset;
}

static createEventPointer(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, relaysOffset:flatbuffers.Offset, authorOffset:flatbuffers.Offset, kind:bigint):flatbuffers.Offset {
  EventPointer.startEventPointer(builder);
...
unpack(): EventPointerT {
  return new EventPointerT(
    this.id(),
...
unpackTo(_o: EventPointerT): void {
  _o.id = this.id();
...
export class EventPointerT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const relays = EventPointer.createRelaysVector(builder, builder.createObjectOffsetList(this.relays));
  const author = (this.author !== null ? builder.createString(this.author!) : 0);

  return EventPointer.createEventPointer(builder,
    id,
    relays,
    author,
    this.kind
