...
readRelays(index: number):string
readRelays(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
readRelays(index: number,optionalEncoding?:any):string|Uint8Array|null {
