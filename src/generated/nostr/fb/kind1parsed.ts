...
unpackTo(_o: Kind1ParsedT): void {
  _o.parsedContent = this.bb!.createObjList(this.parsedContent.bind(this), this.parsedContentLength());
  _o.shortenedContent = this.bb!.createObjList(this.shortenedContent.bind(this), this.shortenedContentLength());
  _o.quotes = this.bb!.createObjList(this.quotes.bind(this), this.quotesLength());
