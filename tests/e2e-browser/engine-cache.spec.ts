...
test('WASM engine persists events and returns them from cache before EOCE', async ({ page }) => {
	// The E2E page takes ~33s: sub1 (15s) + pause (3s) + sub2 (15s)
	...
	// Sub2 must have received cached events BEFORE EOCE (original test)
