...
//
//  Events are emitted via Lynx GlobalEventEmitter as base64-encoded JSON
//  envelopes. This avoids Lynx's one-shot callback limitation and provides a
//  persistent event stream from native to JS.
//
//  Registration:
