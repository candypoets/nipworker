...
SYMBOLS=(
	...
	"nipworker_clear_signer"
	"nipworker_remove_signer"
	"nipworker_deinit"
	...
	"Java_com_candypoets_nipworker_reactnative_NipworkerReactNativeModule_nipworkerClearSigner"
	"Java_com_candypoets_nipworker_reactnative_NipworkerReactNativeModule_nipworkerRemoveSigner"
	"Java_com_candypoets_nipworker_reactnative_NipworkerReactNativeModule_nipworkerWake"
	"Java_com_candypoets_nipworker_reactnative_NipworkerReactNativeModule_nativeMeshPeerConnected"
	"Java_com_candypoets_nipworker_reactnative_NipworkerReactNativeModule_nativeMeshPeerDisconnected"
	"Java_com_candypoets_nipworker_reactnative_NipworkerReactNativeModule_nativeMeshReceiveFragment"
	"Java_com_candypoets_nipworker_reactnative_NipworkerReactNativeModule_nativeMeshPopOutbound"
)
