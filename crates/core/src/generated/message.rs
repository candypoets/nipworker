...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_MUTE_TARGET: i8 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_MUTE_TARGET: i8 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_MUTE_TARGET: [MuteTarget; 3] = [
  MuteTarget::Content,
  MuteTarget::Tags,
  MuteTarget::Both,
];
...
impl core::fmt::Debug for MuteTarget {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> flatbuffers::Follow<'a> for MuteTarget {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = flatbuffers::read_scalar_at::<i8>(buf, loc);
...
impl flatbuffers::Push for MuteTarget {
    type Output = MuteTarget;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        flatbuffers::emplace_scalar::<i8>(dst, self.0);
    }
...
impl flatbuffers::EndianScalar for MuteTarget {
  type Scalar = i8;
  #[inline]
  fn to_little_endian(self) -> i8 {
    self.0.to_le()
...
impl<'a> flatbuffers::Verifiable for MuteTarget {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl flatbuffers::SimpleToVerifyInSlice for MuteTarget {}
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
...
pub enum PipeConfigT {
  ...
  ChatLimiterPipeConfig(Box<ChatLimiterPipeConfigT>),
...
impl PipeConfigT {
  ...
  pub fn take_chat_limiter_pipe_config(&mut self) -> Option<Box<ChatLimiterPipeConfigT>> {
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_MESSAGE_TYPE: u32 = 11;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_MESSAGE_TYPE: [MessageType; 12] = [
...
impl MessageType {
  ...
  pub const SetSignerResponse: Self = Self(10);
  pub const AuthUrl: Self = Self(11);

  pub const ENUM_MIN: u32 = 0;
  pub const ENUM_MAX: u32 = 11;
  pub const ENUM_VALUES: &'static [Self] = &[
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::SetSignerResponse => Some("SetSignerResponse"),
      Self::AuthUrl => Some("AuthUrl"),
      _ => None,
    }
  }
}
...
impl ParsedDataT {
  ...
  pub fn take_kind_8_parsed(&mut self) -> Option<Box<Kind8ParsedT>> {
  ...
  pub fn as_kind_8_parsed(&self) -> Option<&Kind8ParsedT> {
    if let Self::Kind8Parsed(v) = self { Some(v.as_ref()) } else { None }
  }
  ...
  pub fn as_kind_8_parsed_mut(&mut self) -> Option<&mut Kind8ParsedT> {
    if let Self::Kind8Parsed(v) = self { Some(v.as_mut()) } else { None }
  }
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_MESSAGE: u8 = 12;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_MESSAGE: [Message; 13] = [
  Message::NONE,
  Message::ParsedEvent,
  Message::NostrEvent,
...
impl Message {
  ...
  pub const SetSignerResponse: Self = Self(11);
  pub const AuthUrl: Self = Self(12);
...
pub enum MessageT {
  ...
  Pubkey(Box<PubkeyT>),
  Raw(Box<RawT>),
  SetSignerResponse(Box<SetSignerResponseT>),
  AuthUrl(Box<AuthUrlT>),
}
...
impl MessageT {
  pub fn message_type(&self) -> Message {
    match self {
      ...
      Self::SetSignerResponse(_) => Message::SetSignerResponse,
      Self::AuthUrl(_) => Message::AuthUrl,
    }
  }
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(&self, fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>) -> Option<flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>> {
    match self {
      ...
      Self::SetSignerResponse(v) => Some(v.pack(fbb).as_union_value()),
      Self::AuthUrl(v) => Some(v.pack(fbb).as_union_value()),
    }
  }
  ...
  /// If the union variant matches, return the owned SetSignerResponseT, setting the union to NONE.
  pub fn take_set_signer_response(&mut self) -> Option<Box<SetSignerResponseT>> {
    if let Self::SetSignerResponse(_) = self {
      let v = core::mem::replace(self, Self::NONE);
      if let Self::SetSignerResponse(w) = v {
        Some(w)
      } else {
        unreachable!()
      }
  ...
  /// If the union variant matches, return a reference to the SetSignerResponseT.
  pub fn as_set_signer_response(&self) -> Option<&SetSignerResponseT> {
    if let Self::SetSignerResponse(v) = self { Some(v.as_ref()) } else { None }
  }
  /// If the union variant matches, return a mutable reference to the SetSignerResponseT.
  pub fn as_set_signer_response_mut(&mut self) -> Option<&mut SetSignerResponseT> {
    if let Self::SetSignerResponse(v) = self { Some(v.as_mut()) } else { None }
  }
  /// If the union variant matches, return the owned AuthUrlT, setting the union to NONE.
  pub fn take_auth_url(&mut self) -> Option<Box<AuthUrlT>> {
    if let Self::AuthUrl(_) = self {
      let v = core::mem::replace(self, Self::NONE);
      if let Self::AuthUrl(w) = v {
        Some(w)
      } else {
        unreachable!()
      }
  ...
  /// If the union variant matches, return a reference to the AuthUrlT.
  pub fn as_auth_url(&self) -> Option<&AuthUrlT> {
    if let Self::AuthUrl(v) = self { Some(v.as_ref()) } else { None }
  }
  /// If the union variant matches, return a mutable reference to the AuthUrlT.
  pub fn as_auth_url_mut(&mut self) -> Option<&mut AuthUrlT> {
    if let Self::AuthUrl(v) = self { Some(v.as_mut()) } else { None }
  }
}
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
...
pub struct ArticleInlineT {
  ...
  pub entity: Option<Box<ArticleEntityT>>,
  pub children: Option<Vec<ArticleInlineT>>,
}
...
pub struct ArticleBlockT {
  ...
  pub ordered: bool,
  pub start: u64,
  pub inlines: Option<Vec<ArticleInlineT>>,
  pub children: Option<Vec<ArticleBlockT>>,
}
...
impl<'a> AddressPointer<'a> {
  ...
  pub fn kind(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(AddressPointer::VT_KIND, Some(0)).unwrap()}
  }
  #[inline]
  pub fn pubkey(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AddressPointer::VT_PUBKEY, None).unwrap()}
  }
  #[inline]
  pub fn d(&self) -> &'a str {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AddressPointer::VT_D, None).unwrap()}
  }
  #[inline]
  pub fn relays(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(AddressPointer::VT_RELAYS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AddressPointerBuilder<'a, 'b, A> {
  ...
  pub fn add_pubkey(&mut self, pubkey: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AddressPointer::VT_PUBKEY, pubkey);
  }
  #[inline]
  pub fn add_d(&mut self, d: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AddressPointer::VT_D, d);
  }
  #[inline]
  pub fn add_relays(&mut self, relays: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AddressPointer::VT_RELAYS, relays);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AddressPointerBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl AddressPointerT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    AddressPointer::create(_fbb, &AddressPointerArgs{
      kind,
      pubkey,
      d,
      relays,
...
impl<'a> Request<'a> {
  ...
  pub const VT_MESH_ONLY: flatbuffers::VOffsetT = 32;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_mesh_only(args.mesh_only);
  ...
  #[inline]
  pub fn mesh_only(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Request::VT_MESH_ONLY, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for Request<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("mesh_only", Self::VT_MESH_ONLY, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_mesh_only(&mut self, mesh_only: bool) {
    self.fbb_.push_slot::<bool>(Request::VT_MESH_ONLY, mesh_only, false);
  }
  #[inline]
...
impl core::fmt::Debug for Request<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Request");
      ...
      ds.field("mesh_only", &self.mesh_only());
      ds.finish()
  }
}
#[non_exhaustive]
...
impl<'a> NpubLimiterPipeConfig<'a> {
  ...
  pub fn key_by(&self) -> NpubLimiterKey {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<NpubLimiterKey>(NpubLimiterPipeConfig::VT_KEY_BY, Some(NpubLimiterKey::Author)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> NpubLimiterPipeConfigBuilder<'a, 'b, A> {
  ...
  pub fn add_key_by(&mut self, key_by: NpubLimiterKey) {
    self.fbb_.push_slot::<NpubLimiterKey>(NpubLimiterPipeConfig::VT_KEY_BY, key_by, NpubLimiterKey::Author);
  }
  #[inline]
...
impl<'a> MuteFilterPipeConfig<'a> {
  ...
  #[inline]
  pub fn target(&self) -> MuteTarget {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MuteTarget>(MuteFilterPipeConfig::VT_TARGET, Some(MuteTarget::Both)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for MuteFilterPipeConfig<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<MuteTarget>("target", Self::VT_TARGET, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MuteFilterPipeConfigBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_target(&mut self, target: MuteTarget) {
    self.fbb_.push_slot::<MuteTarget>(MuteFilterPipeConfig::VT_TARGET, target, MuteTarget::Both);
  }
  #[inline]
...
impl<'a> Pipe<'a> {
  ...
  pub fn unpack(&self) -> PipeT {
    let config = match self.config_type() {
      ...
      PipeConfig::ChatLimiterPipeConfig => PipeConfigT::ChatLimiterPipeConfig(Box::new(
...
impl<'a> SignEvent<'a> {
  ...
  pub fn request_id(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(SignEvent::VT_REQUEST_ID, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SignEventBuilder<'a, 'b, A> {
  ...
  pub fn add_request_id(&mut self, request_id: u32) {
    self.fbb_.push_slot::<u32>(SignEvent::VT_REQUEST_ID, request_id, 0);
  }
  #[inline]
...
impl<'a> Kind1Parsed<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.address_refs { builder.add_address_refs(x); }
    if let Some(x) = args.event_refs { builder.add_event_refs(x); }
    if let Some(x) = args.profile_mentions { builder.add_profile_mentions(x); }
  ...
  pub fn unpack(&self) -> Kind1ParsedT {
    ...
    let profile_mentions = self.profile_mentions().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let event_refs = self.event_refs().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let address_refs = self.address_refs().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  #[inline]
  pub fn profile_mentions(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ProfilePointer<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ProfilePointer>>>>(Kind1Parsed::VT_PROFILE_MENTIONS, None)}
  }
  #[inline]
  pub fn event_refs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EventPointer<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EventPointer>>>>(Kind1Parsed::VT_EVENT_REFS, None)}
  }
  #[inline]
  pub fn address_refs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AddressPointer<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AddressPointer>>>>(Kind1Parsed::VT_ADDRESS_REFS, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Kind1Parsed<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ProfilePointer>>>>("profile_mentions", Self::VT_PROFILE_MENTIONS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<EventPointer>>>>("event_refs", Self::VT_EVENT_REFS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<AddressPointer>>>>("address_refs", Self::VT_ADDRESS_REFS, false)?
...
pub struct Kind1ParsedArgs<'a> {
    ...
    pub profile_mentions: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ProfilePointer<'a>>>>>,
    pub event_refs: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EventPointer<'a>>>>>,
    pub address_refs: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AddressPointer<'a>>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> Kind1ParsedBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_profile_mentions(&mut self, profile_mentions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<ProfilePointer<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Kind1Parsed::VT_PROFILE_MENTIONS, profile_mentions);
  }
  #[inline]
  pub fn add_event_refs(&mut self, event_refs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<EventPointer<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Kind1Parsed::VT_EVENT_REFS, event_refs);
  }
  #[inline]
  pub fn add_address_refs(&mut self, address_refs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<AddressPointer<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Kind1Parsed::VT_ADDRESS_REFS, address_refs);
  }
  #[inline]
...
pub struct Kind1ParsedT {
  ...
  pub profile_mentions: Option<Vec<ProfilePointerT>>,
  pub event_refs: Option<Vec<EventPointerT>>,
  pub address_refs: Option<Vec<AddressPointerT>>,
...
impl<'a> BadgeAwardRecipient<'a> {
  ...
  pub fn pubkey(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(BadgeAwardRecipient::VT_PUBKEY, None).unwrap()}
  }
  #[inline]
  pub fn relay(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(BadgeAwardRecipient::VT_RELAY, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> BadgeAwardRecipientBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_pubkey(&mut self, pubkey: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BadgeAwardRecipient::VT_PUBKEY, pubkey);
  }
  #[inline]
  pub fn add_relay(&mut self, relay: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BadgeAwardRecipient::VT_RELAY, relay);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> BadgeAwardRecipientBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<BadgeAwardRecipient<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, BadgeAwardRecipient::VT_PUBKEY,"pubkey");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl BadgeAwardRecipientT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    BadgeAwardRecipient::create(_fbb, &BadgeAwardRecipientArgs{
      pubkey,
      relay,
    })
  }
...
impl<'a> Kind8Parsed<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.badge_relay { builder.add_badge_relay(x); }
    if let Some(x) = args.badge_address { builder.add_badge_address(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> Kind8ParsedT {
    ...
    let badge_relay = self.badge_relay().map(|x| {
      x.to_string()
    });
    let recipients = {
  ...
  pub fn badge_address(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Kind8Parsed::VT_BADGE_ADDRESS, None).unwrap()}
  }
  #[inline]
  pub fn badge_relay(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Kind8Parsed::VT_BADGE_RELAY, None)}
  }
  #[inline]
  pub fn recipients(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BadgeAwardRecipient<'a>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BadgeAwardRecipient>>>>(Kind8Parsed::VT_RECIPIENTS, None).unwrap()}
  }
  #[inline]
  pub fn content(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Kind8Parsed::VT_CONTENT, None)}
  }
}
...
impl flatbuffers::Verifiable for Kind8Parsed<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("badge_address", Self::VT_BADGE_ADDRESS, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("badge_relay", Self::VT_BADGE_RELAY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BadgeAwardRecipient>>>>("recipients", Self::VT_RECIPIENTS, true)?
...
pub struct Kind8ParsedArgs<'a> {
    ...
    pub recipients: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BadgeAwardRecipient<'a>>>>>,
    pub content: Option<flatbuffers::WIPOffset<&'a str>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> Kind8ParsedBuilder<'a, 'b, A> {
  ...
  pub fn add_badge_address(&mut self, badge_address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Kind8Parsed::VT_BADGE_ADDRESS, badge_address);
  }
  #[inline]
  pub fn add_badge_relay(&mut self, badge_relay: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Kind8Parsed::VT_BADGE_RELAY, badge_relay);
  }
  #[inline]
  pub fn add_recipients(&mut self, recipients: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<BadgeAwardRecipient<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Kind8Parsed::VT_RECIPIENTS, recipients);
  }
  #[inline]
  pub fn add_content(&mut self, content: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Kind8Parsed::VT_CONTENT, content);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> Kind8ParsedBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    Kind8ParsedBuilder {
      fbb_: _fbb,
      start_: start,
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<Kind8Parsed<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, Kind8Parsed::VT_BADGE_ADDRESS,"badge_address");
    self.fbb_.required(o, Kind8Parsed::VT_RECIPIENTS,"recipients");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct Kind8ParsedT {
  ...
  pub recipients: Vec<BadgeAwardRecipientT>,
  pub content: Option<String>,
}
impl Default for Kind8ParsedT {
  fn default() -> Self {
    Self {
      badge_address: "".to_string(),
      badge_relay: None,
...
impl Kind8ParsedT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    ...
    let badge_relay = self.badge_relay.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let recipients = Some({
      let x = &self.recipients;
    ...
    Kind8Parsed::create(_fbb, &Kind8ParsedArgs{
      badge_address,
      badge_relay,
      recipients,
      content,
...
pub struct Kind30023ParsedT {
  ...
  pub content: Option<String>,
  pub article_blocks: Option<Vec<ArticleBlockT>>,
}
...
impl<'a> ParsedEvent<'a> {
  ...
  pub fn unpack(&self) -> ParsedEventT {
    ...
    let parsed = match self.parsed_type() {
      ...
      ParsedData::Kind8Parsed => ParsedDataT::Kind8Parsed(Box::new(
...
impl<'a> Pubkey<'a> {
  ...
  pub fn error(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Pubkey::VT_ERROR, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PubkeyBuilder<'a, 'b, A> {
  ...
  pub fn add_error(&mut self, error: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Pubkey::VT_ERROR, error);
  }
  #[inline]
...
impl<'a> SignedEvent<'a> {
  ...
  pub fn event(&self) -> Option<NostrEvent<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<NostrEvent>>(SignedEvent::VT_EVENT, None)}
  }
  #[inline]
  pub fn request_id(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(SignedEvent::VT_REQUEST_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn error(&self) -> Option<&'a str> {
    // Safety:
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SignedEventBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_request_id(&mut self, request_id: u32) {
    self.fbb_.push_slot::<u32>(SignedEvent::VT_REQUEST_ID, request_id, 0);
  }
  #[inline]
  pub fn add_error(&mut self, error: flatbuffers::WIPOffset<&'b  str>) {
...
pub enum SetSignerResponseOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct SetSignerResponse<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for SetSignerResponse<'a> {
  type Inner = SetSignerResponse<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> SetSignerResponse<'a> {
  pub const VT_PUBKEY: flatbuffers::VOffsetT = 4;
  pub const VT_BUNKER_URL: flatbuffers::VOffsetT = 6;
  pub const VT_ERROR: flatbuffers::VOffsetT = 8;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    SetSignerResponse { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args SetSignerResponseArgs<'args>
  ) -> flatbuffers::WIPOffset<SetSignerResponse<'bldr>> {
    let mut builder = SetSignerResponseBuilder::new(_fbb);
    if let Some(x) = args.error { builder.add_error(x); }
    if let Some(x) = args.bunker_url { builder.add_bunker_url(x); }
    if let Some(x) = args.pubkey { builder.add_pubkey(x); }
    builder.finish()
  ...
  pub fn unpack(&self) -> SetSignerResponseT {
    let pubkey = self.pubkey().map(|x| {
      x.to_string()
    });
    let bunker_url = self.bunker_url().map(|x| {
      x.to_string()
    });
    let error = self.error().map(|x| {
      x.to_string()
  ...
  pub fn pubkey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SetSignerResponse::VT_PUBKEY, None)}
  }
  #[inline]
  pub fn bunker_url(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SetSignerResponse::VT_BUNKER_URL, None)}
  }
  #[inline]
  pub fn error(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SetSignerResponse::VT_ERROR, None)}
  }
}

impl flatbuffers::Verifiable for SetSignerResponse<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("pubkey", Self::VT_PUBKEY, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("bunker_url", Self::VT_BUNKER_URL, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("error", Self::VT_ERROR, false)?
     .finish();
    Ok(())
  }
}
pub struct SetSignerResponseArgs<'a> {
    pub pubkey: Option<flatbuffers::WIPOffset<&'a str>>,
    pub bunker_url: Option<flatbuffers::WIPOffset<&'a str>>,
    pub error: Option<flatbuffers::WIPOffset<&'a str>>,
}
impl<'a> Default for SetSignerResponseArgs<'a> {
  #[inline]
  fn default() -> Self {
    SetSignerResponseArgs {
      pubkey: None,
      bunker_url: None,
      error: None,
    }
...
pub struct SetSignerResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SetSignerResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_pubkey(&mut self, pubkey: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SetSignerResponse::VT_PUBKEY, pubkey);
  }
  #[inline]
  pub fn add_bunker_url(&mut self, bunker_url: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SetSignerResponse::VT_BUNKER_URL, bunker_url);
  }
  #[inline]
  pub fn add_error(&mut self, error: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SetSignerResponse::VT_ERROR, error);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SetSignerResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SetSignerResponseBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<SetSignerResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for SetSignerResponse<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("SetSignerResponse");
      ds.field("pubkey", &self.pubkey());
      ds.field("bunker_url", &self.bunker_url());
      ds.field("error", &self.error());
      ds.finish()
...
#[non_exhaustive]
#[derive(Debug, Clone, PartialEq)]
pub struct SetSignerResponseT {
  pub pubkey: Option<String>,
  pub bunker_url: Option<String>,
  pub error: Option<String>,
}
impl Default for SetSignerResponseT {
  fn default() -> Self {
    Self {
      pubkey: None,
      bunker_url: None,
...
impl SetSignerResponseT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<SetSignerResponse<'b>> {
    let pubkey = self.pubkey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let bunker_url = self.bunker_url.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let error = self.error.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    SetSignerResponse::create(_fbb, &SetSignerResponseArgs{
      pubkey,
      bunker_url,
      error,
    })
...
impl<'a> flatbuffers::Follow<'a> for AuthUrl<'a> {
  type Inner = AuthUrl<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> AuthUrl<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args AuthUrlArgs<'args>
  ) -> flatbuffers::WIPOffset<AuthUrl<'bldr>> {
    let mut builder = AuthUrlBuilder::new(_fbb);
    if let Some(x) = args.request_id { builder.add_request_id(x); }
    if let Some(x) = args.url { builder.add_url(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> AuthUrlT {
    let url = {
      let x = self.url();
      x.to_string()
    };
  ...
  pub fn url(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AuthUrl::VT_URL, None).unwrap()}
  }
  #[inline]
  pub fn request_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(AuthUrl::VT_REQUEST_ID, None)}
  }
}

impl flatbuffers::Verifiable for AuthUrl<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct AuthUrlArgs<'a> {
    pub url: Option<flatbuffers::WIPOffset<&'a str>>,
    pub request_id: Option<flatbuffers::WIPOffset<&'a str>>,
}
impl<'a> Default for AuthUrlArgs<'a> {
  #[inline]
  fn default() -> Self {
    AuthUrlArgs {
      url: None, // required field
...
pub struct AuthUrlBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AuthUrlBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_url(&mut self, url: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AuthUrl::VT_URL, url);
  }
  #[inline]
  pub fn add_request_id(&mut self, request_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(AuthUrl::VT_REQUEST_ID, request_id);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AuthUrlBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    AuthUrlBuilder {
      fbb_: _fbb,
      start_: start,
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<AuthUrl<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, AuthUrl::VT_URL,"url");
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for AuthUrl<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("AuthUrl");
      ds.field("url", &self.url());
      ds.field("request_id", &self.request_id());
      ds.finish()
  }
...
impl AuthUrlT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<AuthUrl<'b>> {
    let url = Some({
      let x = &self.url;
      _fbb.create_string(x)
    });
    ...
    AuthUrl::create(_fbb, &AuthUrlArgs{
      url,
      request_id,
    })
  }
...
impl<'a> WorkerMessage<'a> {
  ...
  pub fn unpack(&self) -> WorkerMessageT {
    ...
    let content = match self.content_type() {
      ...
      Message::SetSignerResponse => MessageT::SetSignerResponse(Box::new(
        self.content_as_set_signer_response()
            .expect("Invalid union table, expected `Message::SetSignerResponse`.")
            .unpack()
      )),
      Message::AuthUrl => MessageT::AuthUrl(Box::new(
        self.content_as_auth_url()
            .expect("Invalid union table, expected `Message::AuthUrl`.")
            .unpack()
      )),
      _ => MessageT::NONE,
    };
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn content_as_set_signer_response(&self) -> Option<SetSignerResponse<'a>> {
    if self.content_type() == Message::SetSignerResponse {
      self.content().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { SetSignerResponse::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn content_as_auth_url(&self) -> Option<AuthUrl<'a>> {
    if self.content_type() == Message::AuthUrl {
      self.content().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { AuthUrl::init_from_table(t) }
     })
    } else {
      None
    }
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<Message, _>("content_type", Self::VT_CONTENT_TYPE, "content", Self::VT_CONTENT, false, |key, v, pos| {
        match key {
          ...
          Message::SetSignerResponse => v.verify_union_variant::<flatbuffers::ForwardsUOffset<SetSignerResponse>>("Message::SetSignerResponse", pos),
          Message::AuthUrl => v.verify_union_variant::<flatbuffers::ForwardsUOffset<AuthUrl>>("Message::AuthUrl", pos),
          _ => Ok(()),
        }
     })?
     .finish();
  ...
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("WorkerMessage");
      ...
      match self.content_type() {
        ...
        Message::SetSignerResponse => {
          if let Some(x) = self.content_as_set_signer_response() {
            ds.field("content", &x)
          } else {
            ds.field("content", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        ...
        Message::AuthUrl => {
          if let Some(x) = self.content_as_auth_url() {
            ds.field("content", &x)
          } else {
            ds.field("content", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CacheRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_close(&mut self, close: bool) {
