...
use crate::crypto::utils::compute_y_point;

/// Compute Y point from secret using cashu-ts compatible hash_to_curve implementation
///
/// This is a convenience wrapper around the core crypto module.
/// See `crate::crypto::utils::compute_y_point` for more details.
