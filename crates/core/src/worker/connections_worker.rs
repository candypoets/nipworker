...
mod tests {
    ...
    async fn test_parser_nostr_event_publishes_json_event() {
        ...
        local
            .run_until(async {
                let (transport, parser_test, _parser_out_test, _cache_test, _crypto_test) =
                    setup().await;
    ...
    async fn test_reconnect_failure_does_not_drop_frames() {
        ...
        local
            .run_until(async {
                let (transport, _parser_test, _parser_out_test, cache_test, _crypto_test) =
                    setup().await;
    ...
    async fn test_transport_message_callback_builds_worker_message() {
        ...
        local
            .run_until(async {
                let (transport, parser_test, mut parser_out_test, _cache_test, _crypto_test) =
                    setup().await;
